...
class GenerateDataset:
    def __init__(self, class_datas_path=None, dataset_path="dataset", train_size=0.9):
        if class_datas_path is None:
            class_datas_path = ["videos_and_photo/0-plane", "videos_and_photo/1-helicopter"]
